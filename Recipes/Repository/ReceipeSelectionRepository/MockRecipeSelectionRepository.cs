...
namespace Recipes.Repository.ReceipeSelectionRepository
{
    ...
    {
        public MockRecipeSelectionRepository()
        {
        }

        public Task<(List<Recipe> Recipes, bool IsSuccess)> GetRecipesAsync()
        {
            RecipesDto _recipes = new RecipesDto();
            _recipes.recipes = new List<RecipeDto>();

            _recipes.recipes.Add(new RecipeDto
            {
            ...
            return Task.FromResult((Mapper.Map<List<RecipeDto>, List<Recipe>>(_recipes.recipes), true));
        }
    }
}
